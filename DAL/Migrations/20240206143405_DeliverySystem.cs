        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BarcodeDelivery = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GeneratedPackages", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OfficeName = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostalOffices_Areas_AreaId",
                        column: x => x.AreaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostalOffices_Address",
                table: "PostalOffices",
                column: "Address");

            migrationBuilder.CreateIndex(
                name: "IX_PostalOffices_AreaId",
                table: "PostalOffices",
                column: "AreaId");

            migrationBuilder.CreateIndex(
                name: "IX_PostalOffices_Location",
                table: "PostalOffices",
                column: "Location");
